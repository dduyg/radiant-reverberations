...
function draw() {
  ...
  const upperHemisphereCenterY = height / 2 + 20 - sphereRadius * upperHemisphereVerticalAdjustment;
  const lowerHemisphereCenterY = height / 2 + 20 + sphereRadius * lowerHemisphereVerticalAdjustment;
