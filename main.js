...
function draw() {
  ...
  const upperHemisphereCenterY = height / 2 + 50 - sphereRadius * upperHemisphereVerticalAdjustment;
  const lowerHemisphereCenterY = height / 2 + 50 + sphereRadius * lowerHemisphereVerticalAdjustment;
